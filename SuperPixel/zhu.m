...
% im = imread(fileName);
% tic;
name1='C:\Users\15650\Desktop\颈椎相关资料\超像素算法分割颈椎曲率计算\MRI\MRI_data\上海市中医院\上海市中医院-裁剪\301001-320-0000-6';%裁剪2 图片5  裁剪23-T1-6 3  裁剪1135-T1-7 3
name2 = '真实裁剪23-T1-6 3-2';
% tic;
im=imread([name1,'.bmp']);%jpg png
figure,imshow(im);
gray = rgb2gray(im);
